        ...
        <div className="menu-main" style={styles.mainContainer}>
          <div className="menu-grid" style={{...styles.grid, marginRight: showCart ? '380px' : '0'}}>
            {productsLoading ? (
              ...
              <div style={{ textAlign: 'center', gridColumn: '1/-1', padding: '50px', color: '#ef4444' }}>
                <AlertCircle size={40} style={{ margin: '0 auto 15px', opacity: 0.7 }} />
                <p style={{ marginBottom: '10px' }}>Failed to load products</p>
                <p style={{ fontSize: '12px', marginBottom: '15px' }}>{productsError}</p>
                <button 
              ...
              <div style={{ textAlign: 'center', gridColumn: '1/-1', padding: '50px', color: '#999' }}>
                <Search size={40} style={{ margin: '0 auto 15px', opacity: 0.2 }} />
